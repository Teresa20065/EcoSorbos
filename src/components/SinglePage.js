  ...
  return (
    <div className='singlePageMainParent relative top-36'>
      ...
      <div className='bottomImgHold flex flex-row relative gap-8'>
        <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbu1mCIg3Kakx4adnBDt0DnmaSOHcVhLyxxA&s' className=' w-80 si cursor-pointer object-cover' onMouseEnter={imgSrcTarget} onMouseLeave={defaultImageSrc} />
          </div>
      ...
      <div className='spBtnHold relative' onClick={() =>
        ...
        <button className='spAddTOCart' onClick={addItemToCartHandler}> AÑADE A TU CARRITO </button>
      </div>
      ...
      <p className='fof text-4xl spText absolute text-center'>  </p>
      <AutoPlayMethods />
