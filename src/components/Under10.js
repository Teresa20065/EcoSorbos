    ...
    return (
        <div className='u20MainParent fof '>
            ...
            <div className='u20HeadingHold gap-20 justify-center relative flex flex-col'>
                <p className='u20Heading'> BUBLEE TEA </p>
                <p className='u20Desc'> Son popotes mas resistentes y mas anchos para que disfrutes de tus tapiocas.</p>
            </div>
