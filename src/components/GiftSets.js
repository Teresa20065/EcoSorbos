...
const GiftSets = () => {
    return (
        <div className='giftSetMainParent'>
            ...
            <p className='categoryText font-bold'> CATEGORIA</p>

            <div className='flex flex-col gap-8 bestSellerPriceHolder'>

                <Link to={"/under20"} >
                    <p className="hover:underline">Biodegradables</p>
                </Link>

                <Link to={"/under40"} >
                    <p className="hover:underline">  Bublee tea  </p>
                </Link>

                <Link to={"/forher"} >
                    <p className="hover:underline">Comestibles </p>
                </Link>
